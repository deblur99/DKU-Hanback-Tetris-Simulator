...
Java_com_example_myapp_GlobalNative_ledControl(
        JNIEnv *env,
        jclass clazz,
        jint bitCount
) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_myapp_GlobalNative_segmentControl(
        JNIEnv *env,
        jclass clazz,
        jint data
) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_myapp_GlobalNative_lcdClear(
        JNIEnv *env,
        jclass clazz
) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_myapp_GlobalNative_lcdPrint(
        JNIEnv *env,
        jclass clazz,
        jint lineIndex,
        jstring msg
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_myapp_GlobalNative_piezoControl(
        JNIEnv *env,
        jclass clazz,
        jchar data
) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_myapp_GlobalNative_dotMatrixControl(
        JNIEnv *env,
        jclass clazz,
        jstring data
) {
...
Java_com_example_myapp_GlobalNative_fullColorLedControl(
        JNIEnv *env,
        jclass clazz,
        jint led_num,
        jint val1,
